...
void i386Emitter::AsmMov(CpuRegister to, CpuRegister from, int32_t size)
{
    switch (size) {
        case 1: {
...
void i386Emitter::AsmMov(CpuRegister r16, CpuSegment sreg)
{
    uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmMov(CpuSegment sreg, CpuRegister r16)
{
    uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmAdd(CpuRegister to, CpuRegister from, int32_t size)
{
    switch (size) {
        case 1: {
            uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmSub(CpuRegister to, CpuRegister from, int32_t size)
{
    switch (size) {
        case 1: {
            uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmInc(CpuRegister r, int32_t size)
{
    switch (size) {
        case 1: {
            uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmDec(CpuRegister r, int32_t size)
{
    switch (size) {
        case 1: {
            uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmOr(CpuRegister to, CpuRegister from, int32_t size)
{
    switch (size) {
        case 1: {
            uint8_t* a = AllocateBufferForInstruction(2);
...
void i386Emitter::AsmProcLeave(uint16_t retn_imm16, bool restore_sp)
{
    if (restore_sp) {
...
void i386Emitter::AsmProcLeaveNoArgs(uint16_t retn_imm16)
{
    if (retn_imm16 > 0) {
...
void i386Emitter::AsmInt(uint8_t imm8)
{
...
void i386Emitter::AsmInt(uint8_t imm8, uint8_t ah_imm8)
{
